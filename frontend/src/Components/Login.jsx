...
export default function Login() {
	...
	const PostData = async (e) => {
		e.preventDefault()
		await axios.post("https://rvsn.herokuapp.com/login", formData).then((res)=>{
  ...
  return (
    <div>
      <Box mt='5'w='100%'>
          <Box boxShadow='outline' p='0' rounded='md' bg='white' padding={2} mt="10"
           w='100%'>
              ...
              <FormControl onSubmit={handleSubmit} method='POST'>
                  ...
                  <Button onClick={PostData} mt="5" w="50%">Login</Button>
              </FormControl>
          </Box>
      </Box>
    </div>
